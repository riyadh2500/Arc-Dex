...
import { DEXPair }  from "../core/DEXPair.sol";
...
library DEXLibrary {
    ...
    // ── Pair address (CREATE2, deterministic) ────────────────────────────────
    ...
    /// @notice Given some amount of tokenA and reserves, returns the equivalent amount of tokenB.
    ...
    /// @notice Given an exact input amount, returns the output amount (0.3 % fee).
    ...
    /// @notice Given an exact output amount, returns the required input amount (0.3 % fee).
    ...
    /// @notice Performs chained getAmountOut for a multi-hop path.
    ...
    /// @notice Performs chained getAmountIn for a multi-hop path.
